...
public class CardUpdateDto {
    ...
    private List<@Size(max = 200, message = "Example must not exceed 200 characters") String> examples;

    @Size(max = 10, message = "Maximum 10 synonyms allowed")
    private List<@Size(max = 100, message = "Synonym must not exceed 100 characters") String> synonyms;

    @Size(max = 10, message = "Maximum 10 antonyms allowed")
    private List<@Size(max = 100, message = "Antonym must not exceed 100 characters") String> antonyms;
